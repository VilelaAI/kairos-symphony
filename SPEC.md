...
**Versão:** 0.4.0-draft
**Status:** Implementado (conformidade v0.3) — M1-M5 entregues em TypeScript (walking skeleton, confiabilidade, segurança & observabilidade, harness-readiness e loop autônomo). Ver README → [Estado da implementação](README.md#estado-da-implementação)
**Licença:** MIT
