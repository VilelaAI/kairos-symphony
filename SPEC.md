...
**Versão:** 0.4.0-draft
**Status:** Em desenvolvimento — M1 (walking skeleton) e M2 (confiabilidade) implementados em TypeScript; M3-M5 pendentes (ver README → [Estado da implementação](README.md#estado-da-implementação))
**Licença:** MIT
